...
__export(src_exports, {
  ...
  EdgeAddonStoreOptionsStrict: () => EdgeAddonStoreOptionsStrict,
  EdgeApi: () => EdgeApi,
...
var EdgeAddonBaseOptions = import_zod2.z.object({
...
var EdgeAddonStore1_0Options = {
  apiVersion: import_zod2.z.literal("1.0").default("1.0"),
  clientSecret: import_zod2.z.string().min(1).trim(),
  accessTokenUrl: import_zod2.z.string().min(1).trim()
};
var EdgeAddonStore1_1Options = {
  apiVersion: import_zod2.z.literal("1.1"),
  apiKey: import_zod2.z.string().min(1).trim()
};
var EdgeAddonStoreOptions = EdgeAddonBaseOptions.extend({
  ...EdgeAddonStore1_0Options,
  ...EdgeAddonStore1_1Options,
  apiVersion: import_zod2.z.enum(["1.0", "1.1"]).default("1.0")
});
var EdgeAddonStoreOptionsStrict = EdgeAddonBaseOptions.and(
  import_zod2.z.discriminatedUnion("apiVersion", [
    import_zod2.z.object(EdgeAddonStore1_0Options),
    import_zod2.z.object(EdgeAddonStore1_1Options)
  ])
);
...
function resolveConfig(config) {
  ...
  return {
    ...
    edge: edgeZip == null ? void 0 : {
      ...
      apiVersion: config.edge?.apiVersion ?? stringEnv("EDGE_API_VERSION") ?? "1.0",
...
async function initEdge(previousOptions) {
  ...
  if (apiVersion === "1.1") {
    const apiKey = await prompt(
      "Enter your API key:",
      { type: "text" },
      previousOptions?.apiVersion === "1.1" ? previousOptions.apiKey : void 0
    );
    ...
    const clientSecret = await prompt(
      "Enter your client secret:",
      { type: "text" },
      previousOptions?.apiVersion === "1.0" ? previousOptions?.clientSecret : void 0
    );
    const accessTokenUrl = await prompt(
      "Enter your access token URL:",
      { type: "text" },
      previousOptions?.apiVersion === "1.0" ? previousOptions?.accessTokenUrl : void 0
    );
