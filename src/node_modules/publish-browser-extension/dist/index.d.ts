...
declare const InlineConfig: z.ZodObject<{
    ...
    edge: z.ZodOptional<z.ZodObject<{
        ...
        apiVersion: z.ZodOptional<z.ZodDefault<z.ZodEnum<["1.0", "1.1"]>>>;
...
declare const EdgeAddonStoreOptionsStrict: z.ZodIntersection<z.ZodObject<{
    zip: z.ZodString;
    ...
    productId: string;
    skipSubmitReview?: boolean | undefined;
}>, z.ZodDiscriminatedUnion<"apiVersion", [z.ZodObject<{
    apiVersion: z.ZodDefault<z.ZodLiteral<"1.0">>;
    ...
    clientSecret: string;
    accessTokenUrl: string;
    apiVersion?: "1.0" | undefined;
}>, z.ZodObject<{
    apiVersion: z.ZodLiteral<"1.1">;
    apiKey: z.ZodString;
}, "strip", z.ZodTypeAny, {
    apiVersion: "1.1";
    apiKey: string;
...
declare const EdgeAddonStoreOptions: z.ZodObject<{
    ...
    skipSubmitReview: z.ZodDefault<z.ZodBoolean>;
    productId: z.ZodString;
    apiVersion: z.ZodDefault<z.ZodEnum<["1.0", "1.1"]>>;
    apiKey: z.ZodString;
    clientSecret: z.ZodString;
    accessTokenUrl: z.ZodString;
}, "strip", z.ZodTypeAny, {
...
type EdgeAddonStoreOptions = z.infer<typeof EdgeAddonStoreOptionsStrict>;
...
export { type AddonChannel, type AddonDetails, type AddonPagination, type AddonVersion, AddonsApi, type AddonsApiOptions, ChromeWebStore, ChromeWebStoreOptions, CwsApi, type CwsApiOptions, type CwsTokenDetails, type DraftOperation, type DraftResponse, EdgeAddonStore, EdgeAddonStoreOptions, EdgeAddonStoreOptionsStrict, EdgeApi, type EdgeApiOptions, type EdgeTokenDetails, FirefoxAddonStore, FirefoxAddonStoreOptions, InlineConfig, type SubmitResults, type UploadDetails, init, submit };
