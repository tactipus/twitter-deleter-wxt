...
function createListCommand(rettiwt) {
    ...
    var list = (0, commander_1.createCommand)('list').description('Access resources releated to lists');
    // Members
    list.command('members')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, rettiwt.list.members(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    members = _a.sent();
    ...
    list.command('tweets')
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, rettiwt.list.tweets(id, count ? parseInt(count) : undefined, cursor)];
                case 1:
                    tweets = _a.sent();
