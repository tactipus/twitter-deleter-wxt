...
var EdgeAddonBaseOptions = z2.object({
  zip: z2.string().min(1),
...
var EdgeAddonStore1_0Options = {
  apiVersion: z2.literal("1.0").default("1.0"),
  clientSecret: z2.string().min(1).trim(),
  accessTokenUrl: z2.string().min(1).trim()
};
var EdgeAddonStore1_1Options = {
  apiVersion: z2.literal("1.1"),
...
var EdgeAddonStoreOptions = EdgeAddonBaseOptions.extend({
  ...
  apiVersion: z2.enum(["1.0", "1.1"]).default("1.0")
});
var EdgeAddonStoreOptionsStrict = EdgeAddonBaseOptions.and(
  z2.discriminatedUnion("apiVersion", [
    z2.object(EdgeAddonStore1_0Options),
    z2.object(EdgeAddonStore1_1Options)
  ])
);
